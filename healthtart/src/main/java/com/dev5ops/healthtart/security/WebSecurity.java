    ...
    protected SecurityFilterChain configure(HttpSecurity http) throws Exception {
        ...
        http.authorizeHttpRequests((authz) ->
                        authz
                                ...
                                .requestMatchers(new AntPathRequestMatcher("/exercise_equipment/**", "PATCH")).hasRole("ADMIN")
                                .requestMatchers(new AntPathRequestMatcher("/exercise_equipment/**", "DELETE")).hasRole("ADMIN")
                                .requestMatchers(new AntPathRequestMatcher("/gym/**", "GET")).permitAll()
                                .requestMatchers(new AntPathRequestMatcher("/gym/**", "POST")).hasRole("ADMIN")
                                .requestMatchers(new AntPathRequestMatcher("/gym/**", "PATCH")).hasRole("ADMIN")
                                .requestMatchers(new AntPathRequestMatcher("/gym/**", "DELETE")).hasRole("ADMIN")
                                .requestMatchers(new AntPathRequestMatcher("/equipment_per_gym/**", "GET")).permitAll()
                                .requestMatchers(new AntPathRequestMatcher("/equipment_per_gym/**", "POST")).hasRole("ADMIN")
                                .requestMatchers(new AntPathRequestMatcher("/equipment_per_gym/**", "PATCH")).hasRole("ADMIN")
                                .requestMatchers(new AntPathRequestMatcher("/equipment_per_gym/**", "DELETE")).hasRole("ADMIN")
