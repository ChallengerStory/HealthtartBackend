...
|  유제은  | 이 친구는 프로젝트의 아하모먼트가 될 수 있는 부분을 맡아서 해준 친구 입니다. 여러 이슈로 시간이 많이 부족했음에도 뛰어난 실력으로 다해내는 모습이 경이로웠습니다. 제가 어려워서 잘 하지 못하는 부분을 '로그를 찍어가면서 차근차근 하면 해결할 수 있을거다.'라며 제가 직접 해결할 수 있도록 해결책을 주는 팀원을 강하게 키우는 팀원입니다. ㅎㅎ |
